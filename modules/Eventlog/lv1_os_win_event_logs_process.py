...
def EVENTLOGPROCESS(configuration):
    ...
    process_list = []
    process_count = 0
    query = r"SELECT data, event_id, time_created, source, user_sid FROM lv1_os_win_evt_total where (event_id like '4688' or event_id like '4689') and source like '%Security.evtx%'"
