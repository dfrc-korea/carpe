...
class RegistryConnector(interface.ModuleConnector):
    ...
    def Connect(self, configuration, source_path_spec, knowledge_base):
        ...
        query = f"SELECT name, parent_path, extension FROM file_info WHERE (par_id='{par_id}') and " \
                f"((name = 'SYSTEM' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SOFTWARE' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SAM' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'Amcache.hve' and parent_path = 'root/Windows/appcompat/Programs') or " \
                f"(name = 'setupapi.dev.log' and parent_path = 'root/Windows/INF')  or " \
                f"(name = 'SYSTEM.LOG1' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SYSTEM.LOG2' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SOFTWARE.LOG1' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SOFTWARE.LOG2' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SAM.LOG1' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'SAM.LOG2' and parent_path = 'root/Windows/System32/config') or " \
                f"(name = 'Amcache.hve.LOG1' and parent_path = 'root/Windows/appcompat/Programs') or " \
                f"(name = 'Amcache.hve.LOG2' and parent_path = 'root/Windows/appcompat/Programs'))"
        ...
        print('[MODULE]: Registry Connect')

        query3 = f"SELECT name, parent_path, extension FROM file_info WHERE (par_id='{par_id}') and " \
                 f"((name = 'SYSTEM' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SOFTWARE' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SAM' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'Amcache.hve' and parent_path = 'root/Windows.old/Windows/appcompat/Programs') or " \
                 f"(name = 'setupapi.dev.log' and parent_path = 'root/Windows.old/Windows/INF') or " \
                 f"(name = 'SYSTEM.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SYSTEM.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SOFTWARE.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SOFTWARE.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SAM.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'SAM.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config') or " \
                 f"(name = 'Amcache.hve.LOG1' and parent_path = 'root/Windows.old/Windows/appcompat/Programs') or " \
                 f"(name = 'Amcache.hve.LOG2' and parent_path = 'root/Windows.old/Windows/appcompat/Programs'))"

        query4 = f"SELECT name, parent_path, extension FROM file_info WHERE (par_id='{par_id}') and " \
                 f"((name = 'SYSTEM' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SYSTEM.LOG1' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SYSTEM.LOG2' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE.LOG1' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE.LOG2' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM.LOG1' and parent_path = 'root/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM.LOG2' and parent_path = 'root/Windows/System32/config/RegBack'))"

        query5 = f"SELECT name, parent_path, extension FROM file_info WHERE (par_id='{par_id}') and " \
                 f"((name = 'SYSTEM' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SYSTEM.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SYSTEM.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SOFTWARE.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM.LOG1' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack') or " \
                 f"(name = 'SAM.LOG2' and parent_path = 'root/Windows.old/Windows/System32/config/RegBack'))"
        ...
        for registry_file in registry_file_list:
            ...
            for registry in registry_files:
                registry_path = registry[1][registry[1].find('/'):] + '/' + registry[0]
                fileExt = registry[2]
                fileName = registry[0]
            ...
            if backup_flag != 'Backup-RegBack' and reg_am != '':
                print('[MODULE]: Registry - Amcache File')
                insert_data = []
                for amcache in afe.AMCACHEFILEENTRIES(reg_am):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(amcache.file_name),
                               str(amcache.key_last_updated_time), str(amcache.file_extension), str(amcache.program_id),
                               str(amcache.key_id), str(amcache.related_programname),
                               str(amcache.sha1_hash), str(amcache.os_component_flag),
                               str(amcache.full_path), str(amcache.link_date), str(amcache.product_name),
                               str(amcache.size),
                               str(amcache.version), str(amcache.product_version), str(amcache.long_path_hash),
                               str(amcache.binary_type),
                               str(amcache.pe_file_flag), str(amcache.binary_file_version),
            ...
            # Amcache Program
            if backup_flag != 'Backup-RegBack' and reg_am != '':
                print('[MODULE]: Registry - Amcache Program')
                insert_data = []
                for amcache in ape.AMCACHEPROGRAMENTRIES(reg_am):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(amcache.file_name),
                               str(amcache.key_last_updated_time), str(amcache.installed_date), str(amcache.version),
                               str(amcache.publisher), str(amcache.uninstall_date),
                               ...
                               str(amcache.language_code),
                               str(amcache.manifest_path),
                               str(amcache.msi_package_code), str(amcache.msi_product_code),
                               str(amcache.package_full_name),
                               str(amcache.program_id),
                               str(amcache.program_instance_id), str(amcache.uninstall_registry_key_path),
                               str(amcache.root_dir_path),
                               str(amcache.type), str(amcache.program_source), str(amcache.store_app_type),
            ...
            if backup_flag != 'Backup-RegBack' and reg_software != '':
                print('[MODULE]: Registry - Installed Program')
                count = 0
                        ...
                        for program in ip.INSTALLEDPROGRAMS(reg_software, reg_nt[0]):
                            insert_data.append(tuple(
                                [par_id, configuration.case_id, configuration.evidence_id, str(program.program_name),
                                 str(program.company), str(program.created_date), str(program.key_last_updated_time),
            ...
            if reg_software != '' and reg_system != '':
                print('[MODULE]: Registry - OS Information')
                insert_data = []
                for operating_system in oi.OSINFO(reg_software, reg_system):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id,
                               str(operating_system.operating_system),
                               str(operating_system.release_id), str(operating_system.version_number),
                               str(operating_system.install_time),
                               str(operating_system.product_key), str(operating_system.owner),
                               str(operating_system.display_computer_name),
                               str(operating_system.computer_name), str(operating_system.dhcp_dns_server),
                               str(operating_system.operating_system_version),
                               str(operating_system.build_number), str(operating_system.product_id),
                               str(operating_system.last_service_pack),
                               str(operating_system.organization), str(operating_system.last_shutdown_time),
                               str(operating_system.system_root),
                               str(operating_system.path), str(operating_system.last_access_time_flag),
                               str(operating_system.timezone_utc),
                               str(operating_system.display_timezone_name), backup_flag,
                               ', '.join(operating_system.source_location)]))
            ...
            # USB Device
            if reg_software != '' and reg_system != '':
                print('[MODULE]: Registry - USB Device')
                insert_data = []
                for usb in ud.USBDEVICES(reg_software, reg_system, text_data):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(usb.device_class_id),
                               str(usb.serial_number), str(usb.type), str(usb.last_connected_time),
                               str(usb.device_description), str(usb.friendly_name),
                               str(usb.manufacturer),
                               str(usb.last_assigned_drive_letter), str(usb.volume_GUID),
                               str(usb.volume_serial_number_decimal),
                               str(usb.volume_serial_number_hex), str(usb.associated_user_accounts),
                               str(usb.first_connected_time),
                               str(usb.first_connected_since_reboot_time), str(usb.driver_install_time),
                               str(usb.first_install_time),
                               str(usb.last_insertion_time), str(usb.last_removal_time), backup_flag,
                               ', '.join(usb.source_location)]))
            ...
            if reg_sam != '' and reg_software != '':
                print('[MODULE]: Registry - User Account')
                insert_data = []
                for user in ua.USERACCOUNTS(reg_sam, reg_software):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(user.user_name),
                               ...
                               str(user.login_script),
                               str(user.profile_path), str(user.account_created_time), str(user.last_login_time),
                               str(user.last_password_change_time), str(user.last_incorrect_password_login_time),
            ...
            # Known DLL
            if reg_system != '':
                print('[MODULE]: Registry - Known DLL')
                insert_data = []
                for dll in kd.KNOWNDLL(reg_system):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(dll.file_name),
                               str(dll.dll_directory), str(dll.dll_directory_32), str(dll.modified_time), backup_flag,
            ...
            # MAC Address
            if reg_system != '':
                print('[MODULE]: Registry - MAC Address')
            ...
            # Network Interface
            if reg_system != '':
                print('[MODULE]: Registry - Network Interface')
                insert_data = []
                for network in ni.NETWORKINTERFACE(reg_system):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(network.enable_dhcp),
                               ...
                               str(network.lease), str(network.lease_obtained_time),
                               str(network.lease_terminate_time), str(network.t1), str(network.t2),
                ...
                query = "Insert into lv1_os_win_reg_network_interface values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"
                if len(insert_data) > 0:
                    configuration.cursor.bulk_execute(query, insert_data)

            # Network Profile
            if reg_software != '':
                print('[MODULE]: Registry - Network Profile')
                insert_data = []
                for network in np.NETWORKPROFILE(reg_software):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(network.profile_name),
                               ...
                               str(network.datecreated), str(network.datelstconnected), str(network.dns),
            ...
            # File Connection
            if reg_software != '':
                print('[MODULE]: Registry - File Connection')
                insert_data = []
                for file in fc.FILECCONNECTION(reg_software):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(file.file_name),
                               str(file.file_path), str(file.command), str(file.file_type), str(file.modified_time),
            ...
            # System service
            if reg_system != '':
                print('[MODULE]: Registry - System service')
                insert_data = []
                for service in ss.SYSTEMSERVICE(reg_system):
                    insert_data.append(
                        tuple([par_id, configuration.case_id, configuration.evidence_id, str(service.service_name),
                               ...
                               str(service.host_service),
                               str(service.hosted_service_parameter), str(service.modified_time),
            ...
            if backup_flag != 'Backup-RegBack' and len(reg_nt_list) != 0:
                print('[MODULE]: Registry - User Assist')
                for reg_nt in reg_nt_list:
                    insert_data = []
                    for user in u.USERASSIST(reg_nt[0]):
                        insert_data.append(
                            tuple([par_id, configuration.case_id, configuration.evidence_id, str(user.file_name),
                                   ...
                                   str(user.last_run_time), str(user.focus_count),
                                   str(user.focus_seconds), str(reg_nt[1]), backup_flag,
                                   ', '.join(user.source_location)]))
            ...
            if backup_flag != 'Backup-RegBack' and len(reg_usrclass_list) != 0:
                print('[MODULE]: Registry - MUI Cache')
            ...
            # Network Drive
            if backup_flag != 'Backup-RegBack' and len(reg_nt_list) != 0:
                print('[MODULE]: Registry - Network Drive')
                for reg_nt in reg_nt_list:
                    insert_data = []
                    for drive in nd.NETWORKDRIVE(reg_nt[0]):
                        insert_data.append(
                            tuple([par_id, configuration.case_id, configuration.evidence_id,
                                   str(drive.network_drive_name),
                                   str(drive.modified_time), str(drive.ordering), str(reg_nt[1]), backup_flag,
                                   ', '.join(drive.source_location)]))
            ...
            # Recent Docs
            if backup_flag != 'Backup-RegBack' and len(reg_nt_list) != 0:
                print('[MODULE]: Registry - Recent Docs')
                for reg_nt in reg_nt_list:
                    insert_data = []
                    for doc in rd.RECENTDOCS(reg_nt[0]):
                        insert_data.append(
                            tuple([par_id, configuration.case_id, configuration.evidence_id, str(doc.file_folder_name),
                                   str(doc.file_folder_link), str(doc.modified_time),
                                   str(doc.registry_order), str(doc.value), str(reg_nt[1]), backup_flag,
                                   ', '.join(doc.source_location)]))
            ...
            if backup_flag != 'Backup-RegBack' and reg_software != '' and len(reg_nt_list) != 0:
                print('[MODULE]: Registry - Start list')
                count = 0
                for reg_nt in reg_nt_list:
                    insert_data = []
                    if count == 0:
                            ...
                            insert_data.append(
                                tuple(
                                    [par_id, configuration.case_id, configuration.evidence_id, str(start.program_name),
                                     str(start.path), str(start.modified_time), str(start.type), str(reg_nt[1]),
            ...
            # MRU Foloder
            if backup_flag != 'Backup-RegBack' and len(reg_nt_list) != 0:
                print('[MODULE]: Registry - MRU Folder')
                for reg_nt in reg_nt_list:
                    insert_data = []
                    for mru in mf.MRUFOLDER(reg_nt[0]):
                        insert_data.append(
                            tuple([par_id, configuration.case_id, configuration.evidence_id, str(mru.program_name),
                                   str(mru.accessed_folder), str(mru.modified_time),
                                   str(mru.registry_order), str(mru.value), str(reg_nt[1]), backup_flag,
            ...
            print('[MODULE]: Registry [' + backup_flag + '] Completed')

        # except Exception as e:
        #    print("Registry Connector Error: %s" % e)
