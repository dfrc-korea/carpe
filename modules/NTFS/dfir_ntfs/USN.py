...
ReasonList = {
	USN_REASON_BASIC_INFO_CHANGE: 'A user has either changed one or more file or directory attributes or one or more time stamps.',
	USN_REASON_CLOSE: 'The file or directory is closed.',
	USN_REASON_COMPRESSION_CHANGE: 'The compression state of the file or directory is changed from or to compressed.',
	...
	USN_REASON_EA_CHANGE: 'The user made a change to the extended attributes of a file or directory.',
	...
	USN_REASON_HARD_LINK_CHANGE: 'An NTFS file system hard link is added to or removed from the file or directory.',
	USN_REASON_INDEXABLE_CHANGE: 'A user changes the FILE_ATTRIBUTE_NOT_CONTENT_INDEXED attribute.',
	USN_REASON_INTEGRITY_CHANGE: 'A user changed the state of the FILE_ATTRIBUTE_INTEGRITY_STREAM attribute for the given stream.',
	USN_REASON_NAMED_DATA_EXTEND: 'The one or more named data streams for a file are extended (added to).',
	USN_REASON_NAMED_DATA_OVERWRITE: 'The data in one or more named data streams for a file is overwritten.',
	USN_REASON_NAMED_DATA_TRUNCATION: 'The one or more named data streams for a file is truncated.',
	USN_REASON_OBJECT_ID_CHANGE: 'The object identifier of a file or directory is changed.',
	USN_REASON_RENAME_NEW_NAME: 'A file or directory is renamed, and the file name in the USN_RECORD_V2 structure is the new name.',
	USN_REASON_RENAME_OLD_NAME: 'The file or directory is renamed, and the file name in the USN_RECORD_V2 structure is the previous name.',
	USN_REASON_REPARSE_POINT_CHANGE: 'The reparse point that is contained in a file or directory is changed, or a reparse point is added to or deleted from a file or directory.',
	USN_REASON_SECURITY_CHANGE: 'A change is made in the access rights to a file or directory.',
	USN_REASON_STREAM_CHANGE: 'A named stream is added to or removed from a file, or a named stream is renamed.',
	USN_REASON_TRANSACTED_CHANGE: 'The given stream is modified through a TxF transaction.'
}
