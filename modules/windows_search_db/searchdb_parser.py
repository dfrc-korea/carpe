...
class WindowsSearchDBParser():
    def parse(self, database):
        ...
        for value_entry in range(0, systemindex_gthr.records[0].number_of_values):
        ...
        for record in systemindex_gthr.records:
            ...
            for value_entry in range(0, record.number_of_values):
                if column_name_list[value_entry] == 'ScopeID' or column_name_list[value_entry] == 'DocumentID' or \
                    column_name_list[value_entry] == 'SDID' or column_name_list[value_entry] == 'TransactionFlags' or \
                    column_name_list[value_entry] == 'TransactionExtendedFlags' or column_name_list[value_entry] == 'CrawlNumberCrawled' or \
                    column_name_list[value_entry] == 'StartAddressIdentifier' or column_name_list[value_entry] == 'Priority' or \
                    column_name_list[value_entry] == 'AppOwnerId' or column_name_list[value_entry] == 'RequiredSIDs' or \
                    column_name_list[value_entry] == 'DeletedCount' or column_name_list[value_entry] == 'RunTime' or \
                    column_name_list[value_entry] == 'FailureUpdateAttempts' or column_name_list[value_entry] == 'ClientID' or \
                    column_name_list[value_entry] == 'LastRequestedRunTime' or column_name_list[value_entry] == 'StorageProviderId' or \
                    column_name_list[value_entry] == 'CalculatedPropertyFlags':
