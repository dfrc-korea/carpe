...
class ModuleJFIF(ModuleComponentInterface):
    ...
    def __init__(self):
        ...
        self.off_t.name      = "jpg"    # alias
        self.off_t.signature = "jfif"    # signature in C_defy.SIGNATURE
    ...
    def carve(self):
        ...
        self.offset = self.signature(self.get_attrib(ModuleConstant.IMAGE_BASE), sigJFIF_FOOTER)
...
if __name__ == '__main__':
    ...
    file.set_attrib(ModuleConstant.IMAGE_LAST, ModuleJFIF.CONST_SEARCH_SIZE)  # Set offset of the file last
    cret = file.execute()
