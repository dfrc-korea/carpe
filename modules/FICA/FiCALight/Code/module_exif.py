...
class ModuleEXIF(ModuleComponentInterface):
    CONST_KILOBYTE = 1024
    ...
    def __init__(self):
        ...
        self.set_attrib(ModuleConstant.NAME,"EXIF")
        ...
        self.off_t.signature = "exif"    # signature in C_defy.SIGNATURE
...
if __name__ == '__main__':
    ...
    file.set_attrib(ModuleConstant.IMAGE_LAST, ModuleEXIF.CONST_SEARCH_SIZE)  # Set offset of the file last
    cret = file.execute()
    print(cret)
