...
class Carpe_File(object):
	def __init__(self):
		...
		self._ctime_nano = 0
		self._etime_nano = 0
		self._extend_mtime = 0
		self._extend_atime = 0
		self._extend_ctime = 0
		self._extend_etime = 0		
		self._extend_mtime_nano = 0
		self._extend_atime_nano = 0
		self._extend_ctime_nano = 0
		self._extend_etime_nano = 0
		self._mode = 0
		self._uid = 0
		self._gid = 0
		self._hash = ""
