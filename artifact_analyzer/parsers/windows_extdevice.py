...
class WindowsExternalDevice(parser_interface.ParserInterface):
  """
  Windows Operating System External Device Connection History
  """
  def __init__(self):
        ...
        for value in values:
          ...
          if len(results) == 0:
            ...
            for result in results:
              ...
              _data.append(data[5].split(':')[1])
              _data.append(data[6].split(':')[1])
              _data.append(data[7].split(':')[1])
              _data.append(data[8].split(':')[1])
              _data.append(data[9].split(':')[1])
