...
class FileArtifcatPreprocessorPlugin(FileEntryArtifactPreprocessorPlugin):
...
class WindowsRegistryValueArtifactPreprocessorPlugin(WindowsRegistryKeyArtifactPreprocessorPlugin):
