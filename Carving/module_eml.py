...
class ModuleEML(ModuleComponentInterface):
    CONST_KILOBYTE = 1024
    ...
    def __init__(self):
        ...
        self.set_attrib(ModuleConstant.NAME,"EML    ")
    ...
    def carve(self):
        sigEML_FOOTER = b'\x00\x00\x00\x00\x00\x00\x00\x00'
...
if __name__ == '__main__':
    ...
    file.set_attrib(ModuleConstant.IMAGE_LAST, ModuleEML.CONST_SEARCH_SIZE)  # Set offset of the file Last
    cret = file.execute()
    print(cret)
